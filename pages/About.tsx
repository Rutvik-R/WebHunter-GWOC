        ...
        <div className="flex flex-grow items-center flex-col md:flex-row">
          ...
          <div className="lg:w-1/2 w-full px-4 py-8">
            ...
            <p className="text-gray-300">
              ...
              suscipit voluptatibus debitis, cumque quae sunt architecto beatae
              veniam quod laudantium voluptate ullam! Cupiditate repellat
              repudiandae voluptatibus. Reiciendis odit molestiae excepturi
              obcaecati cum corrupti atque veritatis minus nihil? Minus
              similique debitis rem distinctio saepe, voluptatem nam, labore
              neque iure quod dolores, inventore quis mollitia aut natus?
              Adipisci!
            </p>
          </div>
        </div>
